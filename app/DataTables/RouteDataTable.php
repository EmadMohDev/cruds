...
class RouteDataTable extends DataTable
{
    ...
    public function html()
    {
        ...
        ->buttons([
            ...
            ->addClass('btn btn-info '. (canUser("routes-create") ? "" : "remove-hidden-element"))
            ...
            ->addClass('btn btn-primary')->action("window.location.href = " . '"' . routeHelper('routes.download'). '"')
            ...
            Button::make('pageLength')->text('<i class="fa fa-sort-numeric-up"></i>')->addClass('btn btn-light page-length '. (canUser("aggregators-create") ? "" : "remove-hidden-element"))->titleAttr(trans('buttons.page-length')),
        ])
        ->responsive(true)
        ->parameters([
