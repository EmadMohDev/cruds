...
class PermissionDataTable extends DataTable
{
    ...
    public function html()
    {
        ...
        ->pageLength(5)
        ->buttons([
            Button::make()->text('<i class="fa fa-plus"></i> <span class="hidden" data-yajra-href="'.routeHelper('permissions.create').'"></span>')->addClass('btn btn-info show-modal-form '. (canUser("permissions-create") ? "" : "remove-hidden-element"))->titleAttr(trans('menu.create-row', ['model' => trans('menu.permission')])),
            Button::make()->text('<i class="fas fa-trash"></i>')->addClass('btn btn-danger multi-delete '. (canUser("permissions-multidelete") ? "" : "remove-hidden-element"))->titleAttr(trans('buttons.multi-delete')),
