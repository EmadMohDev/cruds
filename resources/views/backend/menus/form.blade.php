<div class="card">
    ...
    <div class="card-header bg-primary">
        <h4 class="card-title text-white">
            <i class="fas fa-bars text-white mx-3"></i><span class="mx-1">{{ $title }}</span>
        </h4>
    </div>
        ...
        <div class="card-body">
            ...
            @endif
                ...
                <div class="form-group mb-5">
                    ...
                    <select class="form-control" data-dropdown-parent="#load-form" data-control="select2" name="parent_id" data-placeholder="--- @lang('inputs.select-data', ['data' => trans('menu.menu')]) ---">
